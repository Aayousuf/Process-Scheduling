...
launch(args);
	...
	public void start(Stage primaryStage) throws Exception {
		// TODO Auto-generated method stub
	stage=primaryStage;
	stage.setTitle("SHORTEST JOB FIRS SCHEDULING (Non preemptive)");
	stage.setHeight(600);
	stage.setWidth(800);
...
//////////////////add process////////////////////////////////////////////////////////////
		...
		start.setOnAction(new EventHandler<ActionEvent>() {
			...
			int [] bt = new int[20];
				...
				double awt = 0,att=0;	int wtime=0;
				int btime=0,k=1,min;
				int nop=size;
				for (int i = 0; i < nop; i++) {
					p[i]=i;
